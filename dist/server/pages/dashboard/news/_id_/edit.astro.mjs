...
const $$Edit = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!newsId) {
    return Astro2.redirect("/dashboard/news?error=not_found");
  }
