...
Fecha de publicación <span class="text-red-500">*</span> </label> <input type="date" name="fecha" required class="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"> </div> </div> <div class="mt-8 flex justify-end space-x-3"> ${renderComponent($$result3, "Button", $$Button, { "href": "/dashboard/news", "variant": "secondary" }, { "default": ($$result4) => renderTemplate` Cancelar ` })} ${renderComponent($$result3, "Button", $$Button, { "type": "submit", "variant": "primary" }, { "default": ($$result4) => renderTemplate` Crear Noticia ` })} </div> ` })} </div> </div> </div> </main> </div> ` })}`;
}, "/Users/rodrigoesprella/Documents/FNI/UniversityBlog/src/pages/dashboard/news/create.astro", void 0);

const $$file = "/Users/rodrigoesprella/Documents/FNI/UniversityBlog/src/pages/dashboard/news/create.astro";
